...
if selected == "Contact":
    ...
    with col2:
        ...
        st.write(":point_right: [GitHub](https://github.com/Akshada-Satpute)")
        st.write("    ")
    ...
    with col4:
        ...
        st.write(":point_right: [Linkedin](https://www.linkedin.com/in/akshada-satpute)")
        st.markdown("<h6 style = 'text-align: right; position: fixed; bottom: 0; right: 0;'> © 2022, Created by Akshada Satpute </h6>",
                    unsafe_allow_html=True)
    with col5:
        st.write("    ")
#######################################################################################################################################################################
